...
int main() {
    ...
    if(sr_station.getNumber()==0){std::cout<<"Nie ma takiej stacji"<<std::endl;}    //Jeśli funkcja nie znalazła
    else{
        std::cout<<"Znaleziono: "<<std::endl<<                                      //Jeśli znalazła wypisuje na ekran
